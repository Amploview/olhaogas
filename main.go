...
func genericExecTemplate(w http.ResponseWriter, r *http.Request, html string, tmplgeneric template.Template, d data) {
	...
	case "sobre":
		println("é sobre")
	case "cadastro_area":
		cadastro_area(w, r, html)
	case "cadastro_glp":
		cadastro_glp(w, r, html)
	case "cadastro_preco":
		cadastro_preco(w, r, html)
	case "cadastro_cliente":
		cadastro_cliente(w, r, html)
	case "cadastro_cobertura":
		cadastro_cobertura(w, r, html)
	case "cadastro_usuario":
		cadastro_usuario(w, r, html)
	case "cadastro_pedido":
		cadastro_pedido(w, r, html)
	case "relatorio_area":
		relatorio_area(w, r, html)
	case "relatorio_glp":
		relatorio_glp(w, r, html)
	case "relatorio_preco":
		relatorio_preco(w, r, html)
	case "relatorio_cliente":
		relatorio_cliente(w, r, html)
	case "relatorio_pedido":
		relatorio_pedido(w, r, html)
		//case "relatorio_cobertura":
		//	relatorio_cobertura(w, r, html)
		//case "relatorio_usuario":
		//	relatorio_usuario(w, r, html)
	}
}
...
func main() {
	...
	//Menu e demais
	data_olhaogas := data{title, header, host}
	...
	data_cadastros := data{title, header, host}
	...
	data_relatorios := data{title, header, host}
	...
	data_sobre := data{title, header, host}
	...
	//Cadastros
	data_cadastroarea := data{title, header, host}
	...
	data_cadastroglp := data{title, header, host}
	...
	data_cadastropreco := data{title, header, host}
	...
	data_cadastrocliente := data{title, header, host}
	...
	data_cadastrocobertura := data{title, header, host}
	...
	data_cadastrousuario := data{title, header, host}
	...
	data_cadastropedido := data{title, header, host}
	...
	//Relatorios
	data_relatorioarea := data{title, header, host}
	...
	data_relatorioglp := data{title, header, host}
	...
	data_relatoriopreco := data{title, header, host}
	...
	data_relatoriocliente := data{title, header, host}
	...
	data_relatoriopedido := data{title, header, host}
	...
	//data_relatoriocobertura := data{title, header, host}
	...
	//})
	//data_relatoriousuario := data{title, header, host}
