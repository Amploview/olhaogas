...
func main() {
	...
	//Declare Tabela
	var Tabela [sizeRows][sizeCols]string
	//Menu e demais
	data_olhaogas := data{title, header, host, db, Tabela}
	...
	data_cadastros := data{title, header, host, db, Tabela}
	...
	data_relatorios := data{title, header, host, db, Tabela}
	...
	data_sobre := data{title, header, host, db, Tabela}
	...
	//Cadastros
	data_cadastroarea := data{title, header, host, db, Tabela}
	...
	data_cadastroglp := data{title, header, host, db, Tabela}
	...
	data_cadastropreco := data{title, header, host, db, Tabela}
	...
	data_cadastrocliente := data{title, header, host, db, Tabela}
	...
	data_cadastrocobertura := data{title, header, host, db, Tabela}
	...
	data_cadastrousuario := data{title, header, host, db, Tabela}
	...
	data_cadastropedido := data{title, header, host, db, Tabela}
	...
	//Relatorios
	data_relatorioarea := data{title, header, host, db, Tabela}
	...
	data_relatorioglp := data{title, header, host, db, Tabela}
	...
	data_relatoriopreco := data{title, header, host, db, Tabela}
	...
	data_relatoriocliente := data{title, header, host, db, Tabela}
	...
	data_relatoriopedido := data{title, header, host, db, Tabela}
	...
	//data_relatoriocobertura := data{title, header, host, db, Tabela}
	...
	//})
	//data_relatoriousuario := data{title, header, host, db, Tabela}
