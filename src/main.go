...
func main() {
	...
	//Menu e demais
	data_olhaogas := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_cadastros := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_relatorios := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_sobre := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	//Cadastros
	data_cadastroarea := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_cadastroglp := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_cadastropreco := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_cadastrocliente := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_cadastrocobertura := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_cadastrousuario := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_cadastropedido := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	//Relatorios
	data_relatorioarea := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_relatorioglp := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_relatoriopreco := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_relatoriocliente := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	data_relatoriopedido := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	//data_relatoriocobertura := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
	...
	//})
	//data_relatoriousuario := data{title, header, host, db, TabelaDados, -1, Area, Glp, Cliente, Usuario, Flg_Tipo_Usuario}
